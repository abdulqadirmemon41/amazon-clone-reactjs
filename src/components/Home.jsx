        ...
        <div className = "home">
           ...
           <div className="home__row">
               {/* Product id, title, price, rating, image */}
                ...
                <Product 
                id = "123456"
                title = "Echo (3rd Generation) | Smart speaker with Alexa- Charcoal Fabric"
                price = {98.99}
                rating = {5}
           ...
           <div className="home__row">
               {/* Product id, title, price, rating, image */}
                <Product 
                id = "123458"
                title = "Samsung 49-Inch CHG90 144Hz Curved Gaming Monitor (LC49HG90DMNXZA) – Super Ultrawide Screen QLED Computer Monitor, 3840 x 1080p Resolution, 1ms..."
